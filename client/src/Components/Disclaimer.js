						...
						<div class="row content">
							...
							>
								...
								<p class="fst-italic">
									...
									for general information purposes only. The
									information is provided by Gurukrupa
									Enterprises and while we endeavor to keep
									the information up to date and correct, we
									...
									the website or the information, products,
									services, or related graphics contained on
									the website for any purpose. Any reliance
									you place on such information is therefore
									strictly at your own risk. In no event will
									we be liable for any loss or damage
									including without limitation, indirect or
									consequential loss or damage, or any loss or
									damage whatsoever arising from loss of data
									or profits arise out of, or in connection
									with, the use of this website. Through this
									website you are able to link to other
									websites which are not under the control of
									Gurukrupa Enterprises. We have no control
									...
									and running smoothly. However, Gurukrupa
									Enterprises takes no responsibility for, and
								...
								<ul>
									<li>
										<i class="bi bi-check"></i> survey no
										43/7 karan park , Somnath nagar ,
										Wadgaon sheri
									</li>
								</ul>
							</div>
