...
export default function Summary() {
  ...
  const getPlayerData = async () => {
    try {
      const data = await axios.get(
        "http://localhost:3001/api/WAGMasterGetConsolidated"
      );
  ...
  const pending = [
    ...
    { dataField: "Bb", text: "Bb", sort: true, filter: textFilter(), footer: "",editable: false ,hidden:true},
    { dataField: "Total", text: "total", sort: true, filter: textFilter(), footer: "",editable: false},
    { dataField: "Ub", text: "Ub", sort: true, filter: textFilter(), footer: "", editable: false},
